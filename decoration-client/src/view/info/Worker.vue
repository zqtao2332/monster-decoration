    ...
    <div>
        ...
        <div class="content feedback">
                        ...
                        <div class="item-content">
                            ...
                            <div class="item-inner">
                                ...
                                <div class="item-input">
                                    <input v-model="formInfo.workerCategoryName" type="text" placeholder="请输入类别名">
                                </div>
                            </div>
                        </div>
                    </li>
            ...
            <div class="content-block">
                ...
                <div class="item-input">
                    <textarea v-model="formInfo.workerCategoryDesc" rows="7" placeholder="请输入技术类别描述，不得少于五个字"></textarea>
                </div>
            </div>
